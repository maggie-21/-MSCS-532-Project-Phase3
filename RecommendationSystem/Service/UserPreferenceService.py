...
from DSA.AVLTree import AVLTree  # Assuming AVLTree is in DSA directory

class UserPreferenceService:
    def __init__(self):
        self.preference_tree = AVLTree()

    def add_preference(self, user_id, preference):
        """Add or update a user's preference."""
        self.preference_tree.insert(user_id, preference)
        print(f"AVL Tree After Insertion: {self.preference_tree.in_order_traversal()}")
